...
import { nombreSolicitante, rolFromSolicitud, rowMatchesSolicitudFilters, carreraFromSolicitud } from "@/lib/solicitudes-filters";
...
export function ProcesoSolicitudesFilterTable({ rows }: Props) {
