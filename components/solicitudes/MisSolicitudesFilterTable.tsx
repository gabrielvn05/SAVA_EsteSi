...
import { rolFromSolicitud, rowMatchesSolicitudFilters, carreraFromSolicitud } from "@/lib/solicitudes-filters";
...
function emptyFilters(): SolicitudFiltros {
  return { nombre: "", rol: "", carrera: "", fechaDesde: "", fechaHasta: "", estado: "" };
}

export function MisSolicitudesFilterTable({
  rows,
  mostrarFiltros = false
}: Readonly<{ rows: SolicitudListRow[]; mostrarFiltros?: boolean }>) {
    ...
    <>
      ...
      <article className="card" style={{ marginBottom: "1rem" }}>
        ...
        <div className="solicitud-filters">
          ...
          <div>
            <label htmlFor="f-carrera">Carrera</label>
            <CarreraSelect
              id="f-carrera"
              value={f.carrera}
              ...
              {filtered.length === 0 ? (
                ...
                paginated.map((s) => (
                  <tr key={s.id}>
                    ...
                    <td>
                      <span className="text-truncate">{carreraFromSolicitud(s) || "—"}</span>
                    </td>
                    <td>
                    ...
                    <td>
                      <div className="cell-actions">
                        ...
                        <LoadingLink href={`/solicitudes/${s.id}/editar`} className="btn btn--secondary btn--sm" loadingLabel="Abriendo editor…">
                          Editar
                        </LoadingLink>
                      </div>
                    </td>
